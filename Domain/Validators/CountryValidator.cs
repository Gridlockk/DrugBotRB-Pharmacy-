...
public class CountryValidator: AbstractValidator<Country>
{
    public CountryValidator()
    {
        ...
        RuleFor(country => country.Code)
            .Length(2).WithMessage(ValidationMessage.LengthRangeMessage)
            .Matches(@"[A-Z]+").WithMessage(ValidationMessage.WrongCharacters)
            .Must(IsValid).WithMessage(ValidationMessage.IsoError);
